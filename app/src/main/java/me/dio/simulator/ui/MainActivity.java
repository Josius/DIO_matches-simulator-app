...
//    private MatchesAdapter matchesAdapter = new MatchesAdapter(Collections.emptyList()); //implementação do vídeo
...
//        1 - com a variavel abaixo temos acesso a todos os componentes :
    ...
    private void setupHTTPClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://josius.github.io/DIO_matches-simulator-api/")
    ...
    private void setupFloatingActionButton() {
        binding.fabSimulate.setOnClickListener(view -> {
            ...
            //throw new RuntimeException("Testandu Crahsylictcus");
        });
    }
